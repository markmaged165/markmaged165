...
- 🛠 **Tech Stack:** Python, nampay, pandas,matplotlap, seaborn, OpenCV, Scikit-Learn, Tensorflow, karses  Raspberry Pi, SQL.
...
| **Book Recommendation System** | An ML engine that suggests books based on user reading history. | **Scikit-Learn, Pandas** |
